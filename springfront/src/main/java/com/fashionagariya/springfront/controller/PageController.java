...
import com.fashionagariya.springfront.exception.ProductNotFoundException;
...
public class PageController {
	...
	public ModelAndView login(@RequestParam(name = "error", required = false) String error,@RequestParam(name = "logout", required = false) String logout) {
		...
		if(error!=null) {
			mv.addObject("message", "Invalid user credencials.");
		}
	...
	public ModelAndView accessDenied() {
		...
		mv.addObject("errorTitle","Access is denied!");
